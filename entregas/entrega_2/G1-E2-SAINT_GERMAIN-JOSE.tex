...
El primer comentario a la figura surge de la fuerte correlación negativa que el grupo
...
pero de manera positiva con los grupos de 'demografía' e 'igualdad política'. Otras
fuertes correlaciones a mencionar son entre el grupo 'elecciones' y 'espacio cívico y 
académico', entre el de 'sociedad civil' y el de 'índice', entre 'partidos políticos' e
'índice'.
